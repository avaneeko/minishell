...
/*   Updated: 2025/10/15 23:22:00 by jgueon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Ensure that all needed pipe pairs are opened or perform full cleanup on failure.
 * @param n_cmd Number of commands in pipeline.
 * @param pipes_ptr Pointer to the outer pipes array pointer for possible NULLing.
