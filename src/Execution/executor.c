...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/09 20:08:27 by jgueon            #+#    #+#             */
/*   Updated: 2025/10/09 20:15:55 by jgueon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	try_run_parent_builtin(t_app *app, t_command *cmd, t_env *env,
		int *status)
{
	int	saved[2];
	int	infd;
	...
	{
		restore_stdio(saved); /* Critical: restore stdio BEFORE a builtin that may exit(). */
